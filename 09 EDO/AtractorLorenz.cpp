...
int main() {
    ...
    while (!WindowShouldClose()) {
        ...
        DrawText("Sigma: Número Prandtl- Controla escala tiempo en la dinámica ",620, 15, 12, YELLOW);
        DrawText("Rho: Número Rayleigh- Conveccion/Disipacion - para Lorenz = 28 ", 620, 40, 12, GREEN);
        DrawText("Beta: Parámetro geomético- Valor Clasico 8/3 ", 620, 65, 12, BLUE);
